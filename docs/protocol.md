        # Metarep: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metarep.git

        ## Objective

        MetaRep implements a novel replication probability method for meta-analysis, quantifying the probability that a new study will replicate the pooled finding, targeting JAMA.
        ...
        - Code: https://github.com/mahmood726-cyber/metarep.git
        - Dashboard: https://mahmood726-cyber.github.io/metarep/
